        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    ...
                    <div class="content">
                        <h3><a href="../../../backend/web/index.php">Software Engineer</a></h3>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    ...
                    <div class="content">
                        <h3><a href="../../../backend/web/index.php">Graphic Designer</a></h3>
            ...
            <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="job-featured">
                    ...
                    <div class="content">
                        <h3><a href="../../../backend/web/index.php">Managing Director</a></h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12">
                <a class="job-listings" href="../../../backend/web/index.php">
                    <div class="row">
