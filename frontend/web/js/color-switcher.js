...
jQuery('head').append('<link rel="stylesheet" id="colors" href="/frontend/web/css/colors/cyan.css" type="text/css" />');
jQuery('head').append('<link rel="stylesheet" href="/frontend/web/css/color-switcher.css" type="text/css" />');
